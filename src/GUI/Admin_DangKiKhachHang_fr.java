 ...
 * @author haita
 */
public class Admin_DangKiKhachHang_fr extends javax.swing.JFrame {

   
    public Admin_DangKiKhachHang_fr() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        tieptuc_button.setBackground(new java.awt.Color(0, 255, 255));
        tieptuc_button.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        tieptuc_button.setForeground(new java.awt.Color(255, 255, 255));
        ...
        huydangki_button.setBackground(new java.awt.Color(0, 255, 255));
        huydangki_button.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        huydangki_button.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 0, -1, -1));

        panel_2.setBackground(new java.awt.Color(255, 204, 255));
        ...
        xacnhan_button.setBackground(new java.awt.Color(0, 255, 255));
        xacnhan_button.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        back_button.setBackground(new java.awt.Color(0, 255, 255));
        back_button.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        back_button.setForeground(new java.awt.Color(255, 0, 0));
        ...
        reset_button.setBackground(new java.awt.Color(0, 255, 255));
        reset_button.setFont(new java.awt.Font("Segoe UI", 1, 15)); // NOI18N
        ...
        panel_2Layout.setHorizontalGroup(
            ...
            .addGroup(panel_2Layout.createSequentialGroup()
                .addGroup(panel_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(panel_2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cauhoi_txt)
                            .addComponent(cautraloi_txt, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)))
                    .addGroup(panel_2Layout.createSequentialGroup()
                        .addGap(330, 330, 330)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_2Layout.createSequentialGroup()
                ...
                .addComponent(back_button, javax.swing.GroupLayout.PREFERRED_SIZE, 337, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(176, 176, 176))
        );
        ...
        getContentPane().add(panel_2, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 423, -1, -1));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PIC_ICON/nen_all.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_DangKiKhachHang_fr().setVisible(true);
            }
        });
    }
