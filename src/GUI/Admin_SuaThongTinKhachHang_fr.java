...
public class Admin_SuaThongTinKhachHang_fr extends javax.swing.JFrame {

    static String MKHHT;
    public Admin_SuaThongTinKhachHang_fr() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        button_edit_1.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        ...
        xacnhan_button.setBackground(new java.awt.Color(0, 0, 255));
        ...
        reset_button.setBackground(new java.awt.Color(0, 0, 255));
    ...
    private void reset_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reset_buttonActionPerformed
        this.dispose();
        new Admin_SuaThongTinKhachHang_fr().loadThongTinKH(MKHHT);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_SuaThongTinKhachHang_fr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
